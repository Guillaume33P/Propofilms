...
class FilmsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create film" do
    assert_difference('Film.count') do
      post films_url, params: { film: { nom: @film.nom, note: @film.note, synopsis: @film.synopsis } }
    end
  ...
  test "should update film" do
    patch film_url(@film), params: { film: { nom: @film.nom, note: @film.note, synopsis: @film.synopsis } }
